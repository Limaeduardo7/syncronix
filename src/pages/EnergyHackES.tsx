...
const benefits = [
  { title: "Claridad mental al despertar", icon: <Brain className="w-6 h-6" />, color: "#8000FF" },
  { title: "Reducción del ruido mental", icon: <Radio className="w-6 h-6" />, color: "#48FF00" },
  { title: "Enfoque inquebrantable durante el día", icon: <Cpu className="w-6 h-6" />, color: "#8000FF" },
  { title: "Estabilidad emocional bajo presión", icon: <Shield className="w-6 h-6" />, color: "#48FF00" },
  { title: "Sensación de control interno", icon: <Activity className="w-6 h-6" />, color: "#8000FF" },
  { title: "Presencia y autoridad natural", icon: <Sparkles className="w-6 h-6" />, color: "#48FF00" },
];

const offerItems = [
  {
    title: "El Manual Energy Hack (PDF)",
    desc: "La ciencia limpia y directa para asumir el control de tu neuropercepción y tu energía corporal.",
    icon: <Brain className="w-8 h-8" />,
    color: "#8000FF",
  },
  {
    title: "Audio 8D de Inducción (Exclusivo)",
    desc: "La herramienta sonora inmersiva para alinear tu estado interno con la realidad que quieres manifestar.",
    icon: <Headphones className="w-8 h-8" />,
    color: "#48FF00",
  },
  {
    title: "El Protocolo Matinal",
    desc: "Cómo usar el sistema en menos de 10 minutos al día para garantizar la máxima elevación de tu energía.",
...
const steps = [
  { num: "01", label: "Despierta", color: "#8000FF" },
  { num: "02", label: "Ponte los auriculares", color: "#48FF00" },
  { num: "03", label: "Dale play", color: "#8000FF" },
  { num: "04", label: "Reconfigura tu estado interior", color: "#48FF00" },
  { num: "05", label: "Entra en una nueva frecuencia", color: "#8000FF" },
];

const faqs = [
  {
    q: "¿Esto es una meditación guiada?",
    a: "No. Energy Hack utiliza ingeniería sonora 8D con estímulo bilateral, un enfoque técnico y neuroperceptivo, sin misticismo ni visualizaciones.",
  },
  {
    q: "¿Cuánto tiempo tarda en sentirse el resultado?",
    a: "La mayoría de los usuarios reporta un cambio perceptible en el estado interno ya en la primera sesión. Los resultados acumulativos suelen aparecer en los primeros 7 días de uso consistente.",
  },
  {
    q: "¿Necesito auriculares?",
    a: "Sí. La tecnología 8D requiere auriculares para que el estímulo bilateral funcione correctamente. Cualquier auricular sirve.",
  },
  {
    q: "¿Y si no funciona para mí?",
    a: "Tienes 7 días de garantía incondicional. Si no sientes diferencia, devolvemos el 100% de tu inversión sin hacer preguntas.",
  },
];
...
const EnergyHackES = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-black font-sans text-slate-200 selection:bg-purple-500/30 selection:text-purple-200">
      <SEO
        title="ENERGY HACK - Reprograma tu Frecuencia Basal | Syncronix"
        description="Protocolo de reconfiguración neural con audio 8D. Reprograma tu frecuencia basal, silencia el ruido mental y toma el control de tu estado interno en menos de 10 minutos al día."
        keywords="energy hack, reconfiguración neural, audio 8d, frecuencia basal, enfoque mental, protocolo matinal, estado interno, neuropercepción, modelado neuroperceptivo"
      ...
      <PurchaseNotifications purchaseText="acaba de comprar Energy Hack!" justNowText="compró ahora" notifications={brazilianPurchaseNotifications} />
      ...
      <main className="relative flex-1">
        ...
        <section className="relative px-4 pb-20 pt-6 md:pb-28 md:pt-10">
          ...
          <div className="relative z-30 mb-8 text-center md:mb-12">
            <CountdownTimer offerEndsText="Esta oferta termina en:" minutesLabel="Min" secondsLabel="Seg" expiredTitle="¡SE ACABÓ EL TIEMPO!" expiredDescription="Esta es tu última oportunidad. Es ahora o nunca." />
          </div>
            ...
            <div className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
              ...
              <div className="w-full text-center md:w-1/2 md:text-left">
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="aurora-border mb-6 inline-flex items-center gap-2.5 rounded-full border border-violet-500/35 bg-violet-500/8 px-5 py-2.5 backdrop-blur-sm">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-lime-200 md:text-xs">Sistema de Reconfiguración Neural</span>
                </motion.div>
                ...
                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.4 }} className="mb-5 text-2xl font-black leading-[1.15] tracking-tight text-white md:text-3xl lg:text-4xl">
                  <span className="mb-2 block text-lg font-bold text-slate-300 md:text-xl lg:text-2xl">
                    <SplitText text="La realidad externa es un reflejo exacto de tu estado interno. Y estás a punto de hackear el código fuente." className="justify-center md:justify-start" />
                  </span>
                </motion.h1>
                ...
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.6 }} className="mb-8 text-sm font-medium leading-relaxed text-slate-400 md:text-lg">
                  <em>Reconfigura el núcleo de tu mente, alterando la energía que emites, y observa cómo la realidad responde a tu nuevo patrón energético, perceptivo, cinestésico y conductual.</em>
                </motion.p>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.8 }} className="flex flex-col items-center gap-4 md:items-start">
                  ...
                  <span className="flex items-center gap-2 text-xs font-medium text-slate-500 md:text-sm">
                    <Lock className="h-3.5 w-3.5" /> Acceso inmediato · Garantía de 7 días
                  </span>
                </motion.div>

                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }} className="mt-6 flex justify-center md:justify-start">
                  <LiveViewers text="personas están en esta página ahora" color="purple" variant="hero" />
                </motion.div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <h2 className="mb-8 text-3xl font-black leading-tight text-white md:text-5xl">
                <DecryptedText text="El Error de Forzar el Entorno" className="not-italic text-3xl font-black md:text-5xl" />
              </h2>
            </motion.div>
            <div className="grid gap-8 md:grid-cols-2">
              <SpotlightCard spotlightColor="rgba(168,85,247,0.15)" className="p-8 md:p-10">
                <p className="text-lg leading-relaxed text-slate-300">
                  Olvida el intento frustrante de cambiar el mundo a tu alrededor mediante fuerza bruta. Si vives apagando incendios, estancado o atrayendo el mismo patrón de problemas, el error no está en el entorno. <span className="font-bold text-purple-400">Está en tu frecuencia basal.</span>
                </p>
              </SpotlightCard>
              <SpotlightCard spotlightColor="rgba(6,182,212,0.15)" className="p-8 md:p-10">
                <p className="text-lg leading-relaxed text-slate-300">
                  La sociedad te enseñó a luchar contra el reflejo en el espejo. Nosotros vamos a enseñarte a <span className="font-bold text-cyan-400">reconfigurar el núcleo.</span>
                </p>
              </SpotlightCard>
            </div>
          </div>
          ...
          <div className="relative mx-auto max-w-4xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-lime-400/30 bg-lime-400/10 px-4 py-2 shadow-[0_0_30px_rgba(72,255,0,0.12)]">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-lime-200">Ingeniería del Estado Interno</span>
              </div>
              <h2 className="mb-6 text-3xl font-black text-white md:text-5xl">Presentamos  <span className="shimmer-multi">ENERGY HACK: Método de Modelado Neuroperceptivo.</span></h2>
              <p className="mx-auto max-w-3xl text-xl leading-relaxed text-slate-400">Junto al manual de bio-optimización en PDF, recibes el motor central de esta transformación: la <span className="font-bold text-white">Pista de Audio 8D de Reconfiguración Matinal.</span></p>
            </motion.div>
            ...
            <SpotlightCard spotlightColor="rgba(72,255,0,0.18)" className="energy-card p-8 md:p-12">
              <div className="text-center">
                ...
                <h3 className="mb-4 text-2xl font-black text-white md:text-3xl">Cuando despiertas y te pones los auriculares, comienza la configuración quirúrgica de tu estado interior</h3>
                <p className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-400">Cuando despiertas y te pones los auriculares, no solo estás escuchando sonido. La ingeniería sonora espacial viaja por ambos hemisferios cerebrales, creando un aislamiento absoluto e induciendo la configuración quirúrgica de tu estado interior profundo.</p>
              </div>
            </SpotlightCard>
          </div>
        </section>
        ...
        <section className="relative px-4 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            <motion.div {...fadeInUp}>
              <h2 className="mb-10 text-3xl font-black leading-tight text-white md:text-5xl">Magnetizando un <span className="bg-gradient-to-r from-violet-400 to-lime-300 bg-clip-text text-transparent">Nivel Superior</span></h2>
              <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-slate-400 md:text-xl">El secreto del modelado de energía es este: la vida que vives es el eco de tu fisiología. Lo que inducimos en este audio es la arquitectura mental y sensorial exacta para que tu realidad externa se vea obligada a reflejar lo que deseas.</p>
            </motion.div>
            ...
            <motion.p {...fadeInUp} className="text-2xl font-black text-white md:text-3xl">Al elevar tu frecuencia en los primeros minutos del día, dejas de reaccionar al caos y empiezas a magnetizar una vida de alto nivel, con <span className="bg-gradient-to-r from-violet-400 to-lime-300 bg-clip-text text-transparent">claridad mental, enfoque inquebrantable y autoridad natural.</span></motion.p>
            <motion.p {...fadeInUp} className="mx-auto mt-8 max-w-3xl text-lg font-semibold leading-relaxed text-slate-300 md:text-xl">Deja de tomar los obstáculos como algo personal. Sé estratégico. Deja de insertar moldes equivocados en el sistema. Ajusta tu input visceral ahora, y la máquina trabajará obligatoriamente a tu favor.</motion.p>
          </div>
        </section>
        ...
        <section className="relative bg-gradient-to-b from-neutral-950/30 to-black px-4 py-24 md:py-32">
          <div className="mx-auto max-w-5xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-black text-white md:text-5xl">Qué cambia cuando tu <span className="shimmer-multi">patrón interno</span> sobe</h2>
            </motion.div>
        ...
        <section className="relative bg-gradient-to-b from-neutral-950/30 to-black px-4 py-24 md:py-32">
          <div className="mx-auto max-w-3xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-lime-400/20 bg-lime-400/5 px-4 py-2"><Play className="h-4 w-4 text-lime-300" /><span className="text-[10px] font-bold uppercase tracking-[0.2em] text-lime-200">Cómo operar el sistema</span></div>
              <h2 className="text-3xl font-black text-white md:text-5xl"><span className="bg-gradient-to-r from-violet-400 to-lime-300 bg-clip-text text-transparent">5 passos.</span> Cada día.</h2>
            </motion.div>
          ...
          <div className="relative z-10 mx-auto max-w-lg">
            <motion.div {...fadeInUp} className="mb-12 text-center">
              <div className="aurora-border mb-6 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/5 px-4 py-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-violet-200">Lo que recibes hoy</span>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} className="mb-12 flex justify-center">
              <div className="relative">
                ...
                <img src="/energy%20hack/Image_in_phone_202604021212.jpeg" alt="Producto Energy Hack" className="relative z-10 w-72 rounded-2xl border-2 border-violet-400/25 shadow-[0_0_80px_-16px_rgba(128,0,255,0.38)] md:w-[28rem]" />
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} className="aurora-border relative overflow-hidden rounded-[2rem] border-2 bg-gradient-to-b from-neutral-950 to-neutral-950/50 p-8 md:p-12" style={{ boxShadow: "0 0 90px -18px rgba(128,0,255,0.35), 0 0 120px -28px rgba(72,255,0,0.2), inset 0 0 60px rgba(0,0,0,0.4)" }}>
              <div className="relative z-10 text-center">
                <div className="mb-8 rounded-2xl border border-white/[0.06] bg-white/[0.03] py-8">
                  ...
                  <p className="mt-3 bg-gradient-to-r from-violet-400 to-lime-300 bg-clip-text text-lg font-black tracking-wide text-transparent">o 2x de R$ 10,47</p>
                ...
                <div className="mt-10 grid grid-cols-3 gap-4 text-[11px] text-slate-500 md:text-xs">
                  ...
                  <div className="flex flex-col items-center gap-1.5 text-center"><ShieldCheck className="h-4 w-4 text-lime-300/70" /><span className="font-semibold">Garantía 7 días</span></div>
                  <div className="flex flex-col items-center gap-1.5 text-center"><Eye className="h-4 w-4 text-violet-300/70" /><span className="font-semibold">Acceso Inmediato</span></div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="relative px-4 py-24 md:py-32">
          <div className="mx-auto max-w-3xl">
            <motion.div {...fadeInUp} className="mb-16 text-center"><h2 className="text-3xl font-black text-white md:text-5xl">Preguntas frecuentes</h2></motion.div>
            <motion.div {...fadeInUp}>
              {faqs.map((faq, idx) => (
          ...
          <div className="mx-auto max-w-3xl">
            <motion.div {...fadeInUp} className="relative overflow-hidden rounded-3xl border border-white/[0.06] bg-gradient-to-b from-white/[0.04] to-transparent p-10 text-center md:p-14">
              ...
              <h3 className="mb-6 text-2xl font-black text-white md:text-3xl">
                Garantía Incondicional de <span className="font-black text-purple-400">7 Días</span>
              </h3>
              ...
              <div className="flex flex-col justify-center gap-6 md:flex-row">
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-sm text-gray-300">7 días para probar</span>
                </div>
                <div className="flex items-center justify-center gap-3">
                  <ShieldCheck className="h-6 w-6 text-purple-400" />
                  <span className="text-sm text-gray-300">Reembolso sin preguntas</span>
                </div>
              </div>
            </motion.div>
          </div>
