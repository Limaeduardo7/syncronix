        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 pt-20 md:pt-32 pb-20">
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            <motion.h1
              ...
              className="text-3xl md:text-6xl lg:text-7xl font-black mb-6 text-black leading-tight"
            >
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                ...
                <div className="relative">
                  ...
                  {/* Bonus Card */}
                  <div className="mb-8 p-6 rounded-2xl bg-gradient-to-br from-slate-900 to-black text-white text-left relative overflow-hidden shadow-lg border border-slate-800">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-green-500/10 rounded-full blur-2xl -mr-16 -mt-16"></div>
                    <div className="relative z-10">
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 mb-3 rounded-full bg-green-500/20 border border-green-500/30 text-green-400 font-bold text-[10px] tracking-wider uppercase">
