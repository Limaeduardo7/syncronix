...
import { englishPurchaseNotifications } from "@/components/quantum-key/notificationsData";
...
const TheUniverseAlgorithm = () => {
    useEffect(() => {
        document.title = "The Universe's Algorithm | The Definitive Manual of Reality";
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="min-h-screen bg-[#050510] text-slate-200 flex flex-col font-sans selection:bg-violet-500/30 selection:text-violet-200">
            <PurchaseNotifications
                purchaseText="just got The Algorithm!"
                justNowText="just now"
                notifications={englishPurchaseNotifications}
            />
            ...
            <main className="flex-1 relative overflow-x-hidden">
                ...
                <section className="relative min-h-[90vh] flex items-center justify-center px-4 pt-10 pb-16">
                    ...
                    <div className="relative z-20 max-w-5xl mx-auto text-center">
                        ...
                        >
                            ...
                            <span className="bg-gradient-to-r from-amber-400 to-violet-400 bg-clip-text text-transparent font-bold">operating the machine in your favor.</span>
                        </motion.p>
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <span className="relative z-10">I WANT ACCESS TO THE ALGORITHM</span>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <motion.div {...fadeInUp} className="space-y-10 text-lg md:text-xl text-slate-300 leading-[1.9]">
                            ...
                            <p className="first-letter:text-6xl first-letter:font-black first-letter:text-amber-500 first-letter:float-left first-letter:mr-3 first-letter:leading-none">
                                You probably consider yourself a good person. You work hard, try to do things the right way, and on some level, expect life to notice your effort.
                            </p>
                            ...
                            >
                                ...
                                <p className="text-white font-black text-3xl md:text-5xl pl-8 leading-[1.2]">
                                    But the results don't match your sacrifice.
                                </p>
                            </motion.div>

                            <p>
                                Mental exhaustion increases. Frustration becomes routine. And the question that echoes in your head at the end of the day is always the same:
                            </p>
                            ...
                            <motion.div {...fadeInUp} className="text-center py-10">
                                <p className="text-amber-500 font-black text-2xl md:text-3xl mb-4">
                                    The answer will hurt, but it will set you free:
                                </p>
                            ...
                            <p>
                                You were taught that the universe is an emotional judge. That it rewards sweat, morality, and stories of overcoming. But reality <span className="text-white font-bold">does not operate on merit</span>. It does not feel pity. It does not evaluate your character.
                            </p>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-white text-xl md:text-2xl font-bold leading-relaxed">
                                        "Reality is a mechanical and impersonal system. And as long as you try to convince the machine with emotions, you will continue to be crushed by its gears."
                                    </p>
                                </div>
                            </motion.div>
                    ...
                    <div className="relative max-w-6xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-20">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-violet-500/30 rounded-full bg-violet-500/10">
                                ...
                                <span className="text-violet-300 font-bold text-[10px] tracking-[0.2em] uppercase">System Decoding</span>
                            </div>
                            <h2 className="text-3xl md:text-6xl font-black text-white mb-8 leading-tight">
                                It was to decode this system that
                                <br />
                                <span className="relative inline-block mt-2">
                                    <span className="bg-gradient-to-r from-violet-300 via-amber-400 to-cyan-300 bg-clip-text text-transparent">The Universe's Algorithm</span>
                            ...
                            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
                                This is not a feel-good self-help material. It is a <span className="text-white font-bold">pragmatic and straight-to-the-point map</span>. It shatters the illusion of "cosmic justice" and places the control panel of reality in your hands.
                            </p>
                            <p className="text-lg text-slate-500 mt-6 max-w-3xl mx-auto italic">
                                You will understand, once and for all, that your pain and exhaustion are not divine punishments or bad luck. They are merely mechanical diagnostics of misalignment.
                            </p>
                        </motion.div>
                            ...
                            {[
                                {
                                    ...
                                    title: "The Funnel",
                                    subtitle: "INPUT",
                                    desc: "Your only point of absolute control. Learn why the system ignores your \"packaging\" and reacts only to your \"raw material\" — your raw internal state.",
                                ...
                                },
                                {
                                    ...
                                    title: "The Gears",
                                    subtitle: "PROCESSING",
                                    desc: "The black box where immutable laws operate. Discover how this invisible press works, replicating and multiplying the exact form of what you insert — without judgments.",
                                ...
                                },
                                {
                                    ...
                                    title: "The Conveyor",
                                    subtitle: "OUTPUT",
                                    desc: "The end of anxiety. Understand why time is not your enemy but a safety filter. The latency in manifesting your results is not a flaw — it's physics.",
                        ...
                        <motion.div {...fadeInUp} className="hidden md:flex items-center justify-center gap-4 mt-12 text-slate-600">
                            <span className="px-4 py-2 rounded-lg bg-violet-500/10 border border-violet-500/20 text-sm font-bold text-violet-300">YOUR INPUT</span>
                            <motion.div animate={{ x: [0, 5, 0] }} transition={{ duration: 1.5, repeat: Infinity }}>
                                <ArrowRight className="w-5 h-5 text-amber-500" />
                            </motion.div>
                            <span className="px-4 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20 text-sm font-bold text-amber-400">PROCESSING</span>
                            <motion.div animate={{ x: [0, 5, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.3 }}>
                                <ArrowRight className="w-5 h-5 text-cyan-400" />
                            </motion.div>
                            <span className="px-4 py-2 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-sm font-bold text-cyan-300">YOUR RESULT</span>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-10 leading-tight">
                                Stop trying to control <span className="text-amber-500">"how"</span> things should happen.
                            </h2>
                            <p className="text-lg md:text-xl text-slate-400 mb-6 max-w-2xl mx-auto">
                                Every time you inject doubt, anxiety, and excessive control into your process, you contaminate the result and <span className="bg-gradient-to-r from-amber-400 to-violet-400 bg-clip-text text-transparent font-bold">jam the gears</span> of your own life.
                            </p>
                        </motion.div>
                        ...
                        <motion.div {...fadeInUp}>
                            <p className="text-2xl md:text-4xl font-black text-white mb-6 leading-tight">
                                The Universe's Algorithm will teach you
                            </p>
                            <motion.p
                            ...
                            >
                                The Engineering of Fulfillment.
                            </motion.p>
                            <p className="text-lg md:text-xl text-slate-400 mb-16 max-w-2xl mx-auto">
                                Eliminate the empty spaces and internal contradictions. Ensure an uninterrupted and logical flow of achievements.
                            </p>
                        </motion.div>
                    ...
                    <div className="max-w-5xl mx-auto relative z-10">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
                                The difference is <span className="bg-gradient-to-r from-amber-500 to-violet-500 bg-clip-text text-transparent">brutal.</span>
                            </h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                            <motion.div {...fadeInUp} className="p-8 md:p-10 rounded-3xl bg-red-500/[0.04] border border-red-500/10">
                                ...
                                <ul className="space-y-5">
                                    {[
                                        "Works hard but results don't come",
                                        "Constant frustration and mental fatigue",
                                        "Feeling of injustice and bad luck",
                                        "Random attempts without method",
                                        "Anxiety from not controlling the future",
                                        "Depends on motivation to act"
                                    ].map((t, i) => (
                            ...
                            <motion.div {...fadeInUp} transition={{ delay: 0.1 }} className="p-8 md:p-10 rounded-3xl bg-amber-500/[0.04] border border-amber-500/10 relative overflow-hidden">
                                ...
                                <ul className="space-y-5 relative z-10">
                                    {[
                                        "Operates with mechanical clarity and direction",
                                        "Internal alignment generates real results",
                                        "Understands it's not unfair — it was misaligned",
                                        "Pragmatic and replicable method",
                                        "Latency is not anxiety — it's process",
                                        "Acts by logic, not by emotion"
                                    ].map((t, i) => (
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            <p className="text-2xl md:text-4xl font-black text-white mb-6">
                                It's time to stop taking life's obstacles <span className="text-amber-500">personally.</span>
                            </p>
                            <p className="text-lg text-slate-400 mb-10">
                                The universe is not against you. You simply didn't have the instruction manual. <span className="text-white font-bold">Until now.</span>
                            </p>
                            <motion.div {...fadeInUp} className="flex justify-center mb-10">
                            ...
                            >
                                <motion.div
                                    ...
                                    transition={{ duration: 2, repeat: Infinity, repeatDelay: 1 }}
                                />
                                <span className="relative z-10">I WANT THE MANUAL NOW</span>
                ...
                {/* MAIN OFFER */}
                <section id="offer" className="relative py-24 md:py-32 px-4 scroll-mt-10 bg-gradient-to-b from-[#050510] via-violet-950/15 to-[#050510]">
                    ...
                    <div className="relative max-w-lg mx-auto z-10">
                        <motion.div {...fadeInUp} className="text-center mb-12">
                            <h2 className="text-3xl md:text-4xl font-black text-white mb-3">
                                Take control. <span className="bg-gradient-to-r from-amber-500 to-violet-500 bg-clip-text text-transparent">Now.</span>
                            </h2>
                        </motion.div>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="text-center mb-10">
                                    <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-5 border border-violet-500/30 rounded-full bg-violet-500/10">
                                        ...
                                        <span className="text-violet-300 font-bold text-[10px] tracking-[0.15em] uppercase">Special Offer</span>
                                    </div>
                                ...
                                <div className="space-y-3 mb-10 text-left">
                                    {[
                                        "Complete e-book: The Universe's Algorithm",
                                        "Funnel → Gears → Conveyor Framework",
                                        "Personal misalignment diagnosis",
                                        "Guide to filling internal gaps",
                                ...
                                <div className="text-center mb-10 py-8 rounded-2xl bg-gradient-to-b from-violet-500/[0.05] to-white/[0.02] border border-violet-500/10">
                                    ...
                                    <p className="text-6xl md:text-7xl font-black text-white tracking-tighter leading-none">
                                        $5<span className="text-4xl text-amber-500">.90</span>
                                    </p>
                                    <p className="text-slate-500 font-medium text-sm mt-4">instant and lifetime access</p>
                                </div>
                    ...
                    <div className="max-w-3xl mx-auto relative z-10">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 border border-violet-500/20 rounded-full bg-violet-500/10">
                                ...
                                <span className="text-violet-300 font-bold text-[10px] tracking-[0.2em] uppercase">Objections eliminated</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-10">
                                Questions your mind <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">will ask</span>
                            </h2>
                        ...
                        <motion.div {...fadeInUp} className="divide-y divide-white/[0.06]">
                            <FAQ q="Is this just another self-help book?" a="No. 'The Universe's Algorithm' uses technical and mechanical language intentionally. There are no creative visualizations, mantras, or 'positive thinking' here. It is a pragmatic diagnosis of the system that governs your results — and an operational manual for you to manipulate it." />
                            <FAQ q="Do I need to believe in something specific for it to work?" a="On the contrary. The material was designed to work regardless of your beliefs. It treats reality as an operating system: it doesn't matter if you 'believe' in gravity — it works anyway. The Algorithm operates with the same logic." />
                            <FAQ q="$5.90 seems too cheap. What's the catch?" a="There's no catch. The price is a strategic decision: we want as many adults as possible to have access to this knowledge. The value of the content inside the material is infinitely greater than the price charged. The question is: how much does it cost to spend another year operating under a lie?" />
                            <FAQ q="What if I don't like it?" a="You are covered by an unconditional 7-day guarantee. If the material doesn't make sense to you for any reason, just request a refund. Zero bureaucracy." />
                            <FAQ q="Is it a digital book?" a="Yes. The Universe's Algorithm is an e-book. After purchase, you receive immediate access to the content. Read on your phone, tablet, or computer — wherever and whenever you want." />
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="max-w-2xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center p-10 md:p-14 rounded-3xl bg-gradient-to-b from-white/[0.04] to-transparent border border-white/[0.06]">
                            ...
                            <h3 className="text-2xl md:text-3xl font-black text-white mb-4">
                                Unconditional <span className="bg-gradient-to-r from-amber-500 to-violet-500 bg-clip-text text-transparent">7-Day</span> Guarantee
                            </h3>
                            <p className="text-slate-400 leading-relaxed mb-8 max-w-lg mx-auto">
                                You have 7 full days to read, apply, and test the content. If for any reason you feel it's not for you, we'll refund <span className="text-white font-bold">100% of your investment</span>. No questions, no bureaucracy.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                <div className="flex items-center gap-2 justify-center text-slate-400">
                                    <Clock className="w-5 h-5 text-amber-500/60" />
                                    <span className="text-sm font-medium">7 days to try</span>
                                </div>
                                <div className="flex items-center gap-2 justify-center text-slate-400">
                                    <CheckCircle className="w-5 h-5 text-amber-500/60" />
                                    <span className="text-sm font-medium">No-questions refund</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            ...
                            <p className="text-slate-600 text-sm italic leading-relaxed max-w-2xl mx-auto">
                                "If you're looking for pats on the back or validation for your victimhood, close this page. This material was written for adult minds who prefer the raw truth that works to the sweet lie that paralyzes. The choice is yours."
                            </p>
                        </motion.div>
                    </div>
                </section>
            ...
            <footer className="py-10 bg-[#050510] border-t border-violet-500/10 text-center">
                <p className="text-slate-600 text-sm">&copy; {new Date().getFullYear()} Syncronix. All rights reserved.</p>
                <p className="text-slate-700 text-xs mt-2">This product does not guarantee results. Results depend on individual application.</p>
            </footer>
        </div>
    );
};

export default TheUniverseAlgorithm;
