                ...
                <section className="relative min-h-[90vh] flex items-center justify-center px-4 pt-10 pb-16">
                    ...
                    <div className="relative z-20 max-w-5xl mx-auto text-center">
                        ...
                        >
                            ...
                            <span className="text-cyan-400 font-bold">operar a máquina ao seu favor.</span>
                        </motion.p>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-cyan-500/20 rounded-full bg-cyan-500/5">
                                ...
                                <span className="text-cyan-300 font-bold text-[10px] tracking-[0.2em] uppercase">Por dentro do e-book</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
                                O que você vai encontrar <span className="text-cyan-400">lá dentro</span>
                            </h2>
                    ...
                    <div className="relative max-w-6xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-20">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-emerald-500/20 rounded-full bg-emerald-500/5">
                                ...
                                <span className="text-emerald-300 font-bold text-[10px] tracking-[0.2em] uppercase">Decodificação do sistema</span>
                            </div>
                            <h2 className="text-3xl md:text-6xl font-black text-white mb-8 leading-tight">
                                Foi para decodificar esse sistema que
                                <br />
                                <span className="relative inline-block mt-2">
                                    <span className="bg-gradient-to-r from-emerald-300 via-cyan-400 to-purple-400 bg-clip-text text-transparent">O Algoritmo do Universo</span>
                        ...
                        <motion.div {...fadeInUp} className="hidden md:flex items-center justify-center gap-4 mt-12 text-slate-600">
                            <span className="px-4 py-2 rounded-lg bg-purple-500/10 border border-purple-500/20 text-sm font-bold text-purple-300">SEU INPUT</span>
                            <ArrowRight className="w-5 h-5 text-cyan-400" />
                            <span className="px-4 py-2 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-sm font-bold text-cyan-300">PROCESSAMENTO</span>
                            <ArrowRight className="w-5 h-5 text-emerald-400" />
                            <span className="px-4 py-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-sm font-bold text-emerald-300">SEU RESULTADO</span>
                        </motion.div>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-10 leading-tight">
                                Pare de tentar controlar o <span className="text-rose-400">"como"</span> as coisas devem acontecer.
                            </h2>
        ...
        ═══════════════════════════════════════════════════════════ */}
                <section className="relative py-24 md:py-32 px-4 bg-gradient-to-b from-neutral-950/30 to-black">
                    <div className="max-w-5xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
                                A diferença é <span className="bg-gradient-to-r from-rose-400 to-amber-400 bg-clip-text text-transparent">brutal.</span>
                            </h2>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            ...
                            <p className="text-2xl md:text-4xl font-black text-white mb-6">
                                Chegou a hora de parar de levar os obstáculos da vida <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">para o lado pessoal.</span>
                            </p>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 border border-rose-500/20 rounded-full bg-rose-500/5">
                                ...
                                <span className="text-rose-300 font-bold text-[10px] tracking-[0.2em] uppercase">Objeções eliminadas</span>
                            </div>
