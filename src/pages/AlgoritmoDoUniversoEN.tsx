...
const SUMARIO_IMAGES = [
  "/algoritmo/Ingles/WhatsApp Image 2026-04-05 at 21.35.03.jpeg",
  "/algoritmo/Ingles/WhatsApp Image 2026-04-05 at 21.35.03 (1).jpeg",
  "/algoritmo/Ingles/WhatsApp Image 2026-04-05 at 21.35.03 (2).jpeg",
  "/algoritmo/Ingles/WhatsApp Image 2026-04-05 at 21.35.03 (3).jpeg",
  "/algoritmo/Ingles/WhatsApp Image 2026-04-05 at 21.35.03 (4).jpeg",
];
    ...
    return (
        <div className="min-h-screen bg-black text-slate-200 flex flex-col font-sans selection:bg-amber-500/30 selection:text-amber-200">
            <SEO
                ...
                description="Discover the mechanical system behind reality and access the e-book The Algorithm of the Universe to operate the machine in your favor."
                keywords="algorithm of the universe, ebook, reality, personal development, alignment, results, reality manual, syncronix"
            ...
            <PurchaseNotifications
                purchaseText="just purchased The Algorithm!"
                justNowText="just purchased"
        ...
        ═══════════════════════════════════════════════════════════ */}
                <section className="relative pt-6 pb-2 px-4 bg-black text-center z-30">
                    <CountdownTimer
                        offerEndsText="This offer ends in:"
                        minutesLabel="Min"
                        secondsLabel="Sec"
                        expiredTitle="TIME IS UP!"
                        expiredDescription="This is your last chance. It's now or never."
                    />
                </section>
                    ...
                    <div className="relative z-20 max-w-5xl mx-auto text-center">
                        ...
                        >
                            ...
                            <span className="text-cyan-300 font-bold text-[10px] md:text-xs tracking-[0.15em] uppercase">
                                Warning: what you are about to read invalidates 99% of what you were taught
                            </span>
                        </motion.div>
                        ...
                        >
                            Discover the cold, mechanical and flawless system behind reality. The definitive manual to stop begging for results and start{" "}
                            <span className="text-cyan-400 font-bold">operating the machine in your favor.</span>
                        </motion.p>
                        ...
                        >
                            ...
                            >
                                <span>I WANT ACCESS TO THE ALGORITHM</span>
                                <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                            </motion.a>
                            <span className="text-slate-500 text-sm font-medium flex items-center gap-2">
                                <Lock className="w-3.5 h-3.5" /> Instant access · 7-day guarantee
                            </span>
                        </motion.div>
                        ...
                        >
                            <LiveViewers text="people are on this page right now" color="yellow" />
                        </motion.div>
                        ...
                        >
                            <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 2, repeat: Infinity }} className="flex flex-col items-center gap-2 text-slate-600">
                                <span className="text-xs font-medium uppercase tracking-widest">Keep reading</span>
                ...
                <section className="relative py-8 border-y border-white/5 bg-neutral-950/30">
                    <div className="max-w-6xl mx-auto px-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 text-center">
                            {[
                                { num: 2847, label: "Copies sold" },
                                { num: 4.9, label: "Average rating", suffix: "/5" },
                                { num: 98, label: "Satisfaction rate", suffix: "%" },
                                { num: 7, label: "Days of guarantee" },
                            ].map((stat, idx) => (
                    ...
                    <div className="max-w-3xl mx-auto">
                        <motion.div {...fadeInUp} className="space-y-10 text-lg md:text-xl text-slate-300 leading-[1.9]">
                            <p className="first-letter:text-6xl first-letter:font-black first-letter:text-purple-400 first-letter:float-left first-letter:mr-3 first-letter:leading-none">
                                You probably consider yourself a good person. You work hard, try to do things the right way and, at some level, expect life to notice your effort.
                            </p>
                            ...
                            >
                                ...
                                <p className="text-white font-black text-3xl md:text-5xl pl-8 leading-[1.2]">
                                    But the results do not match your sacrifice.
                                </p>
                            </motion.div>

                            <p>
                                Mental exhaustion grows. Frustration becomes routine. And the question echoing in your head at the end of the day is always the same:
                            </p>
                            ...
                            >
                                ...
                                <br />Why does it seem so easy for everyone else?"
                            </motion.p>
                            ...
                            <p>
                                You were taught that the universe is an emotional judge. That it rewards sweat, morality and stories of overcoming. But reality <span className="text-white font-bold">does not operate by merit</span>. It feels no pity. It does not evaluate your character.
                            </p>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-white text-xl md:text-2xl font-bold leading-relaxed">
                                        "Reality is a mechanical and impersonal system. And as long as you try to convince the machine with emotions, you will keep being crushed by the gears."
                                    </p>
                                </div>
                            </motion.div>
                        </motion.div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-cyan-500/20 rounded-full bg-cyan-500/5">
                                ...
                                <span className="text-cyan-300 font-bold text-[10px] tracking-[0.2em] uppercase">Inside the e-book</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
                                What you will find <span className="text-cyan-400">inside</span>
                            </h2>
                            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                                Pages designed to decode the system of reality through high-definition mechanical infographics.
                            </p>
                        </motion.div>
                                ...
                                <div className="flex touch-pan-y">
                                    {SUMARIO_IMAGES.map((src, idx) => (
                                        ...
                                        >
                                            ...
                                            <img
                                                src={src}
                                                alt={`Page ${idx + 1} of The Algorithm of the Universe`}
                    ...
                    <div className="relative max-w-6xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-20">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-emerald-500/20 rounded-full bg-emerald-500/5">
                                ...
                                <span className="text-emerald-300 font-bold text-[10px] tracking-[0.2em] uppercase">System decoding</span>
                            </div>
                            <h2 className="text-3xl md:text-6xl font-black text-white mb-8 leading-tight">
                                It was to decode this system that
                                <br />
                                <span className="relative inline-block mt-2">
                                    <span className="bg-gradient-to-r from-emerald-300 via-cyan-400 to-purple-400 bg-clip-text text-transparent">The Algorithm of the Universe</span>
                            ...
                            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
                                This is not soft self-help material. It is a <span className="text-white font-bold">pragmatic, direct map</span>. It breaks the illusion of "cosmic justice" and hands you the control panel of reality.
                            </p>
                            <p className="text-lg text-slate-500 mt-6 max-w-3xl mx-auto">
                                You will understand, once and for all, that your pain and exhaustion are not divine punishments or bad luck. They are only mechanical diagnostics of misalignment.
                            </p>
                        </motion.div>
                            ...
                            {[
                                {
                                    ...
                                    title: "The Funnel",
                                    subtitle: "INPUT",
                                    desc: "Your only point of absolute control. Learn why the system ignores your \"packaging\" and reacts only to your \"raw matter\" — your inner state.",
                                ...
                                },
                                {
                                    ...
                                    title: "The Gears",
                                    subtitle: "PROCESSING",
                                    desc: "The black box where immutable laws operate. Discover how this invisible press works, replicating and multiplying the exact shape of what you feed into it — without judgment.",
                                ...
                                },
                                {
                                    ...
                                    subtitle: "OUTPUT",
                                    desc: "The end of anxiety. Understand why time is not your enemy, but a safety filter. The latency in your results is not a flaw, it is physics.",
                        ...
                        <motion.div {...fadeInUp} className="hidden md:flex items-center justify-center gap-4 mt-12 text-slate-600">
                            <span className="px-4 py-2 rounded-lg bg-purple-500/10 border border-purple-500/20 text-sm font-bold text-purple-300">YOUR INPUT</span>
                            <ArrowRight className="w-5 h-5 text-cyan-400" />
                            <span className="px-4 py-2 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-sm font-bold text-cyan-300">PROCESSING</span>
                            <ArrowRight className="w-5 h-5 text-emerald-400" />
                            <span className="px-4 py-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-sm font-bold text-emerald-300">YOUR RESULT</span>
                        </motion.div>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-10 leading-tight">
                                Stop trying to control <span className="text-rose-400">"how"</span> things should happen.
                            </h2>
                            <p className="text-lg md:text-xl text-slate-400 mb-6 max-w-2xl mx-auto">
                                Every time you inject doubt, anxiety and excessive control into your process, you contaminate the result and <span className="text-white font-bold">jam the gears</span> of your own life.
                            </p>
                        </motion.div>
                        ...
                        <motion.div {...fadeInUp}>
                            <p className="text-2xl md:text-4xl font-black text-white mb-6 leading-tight">
                                The Algorithm of the Universe will teach you
                            </p>
                            ...
                            <p className="text-lg md:text-xl text-slate-400 mb-16 max-w-2xl mx-auto">
                                Eliminate empty spaces and internal contradictions. Guarantee an uninterrupted, logical flow of outcomes.
                            </p>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl mx-auto">
                            {[
                                "No exhausting rituals.",
                                "No need to \"think positive\".",
                                "Only mechanical alignment.",
                                "Cold and highly effective."
                            ].map((text, idx) => (
                                <motion.div
                                    key={idx}
                                    {...stagger}
        ...
        ═══════════════════════════════════════════════════════════ */}
                <section className="relative py-24 md:py-32 px-4 bg-gradient-to-b from-neutral-950/30 to-black">
                    <div className="max-w-5xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
                                The difference is <span className="bg-gradient-to-r from-rose-400 to-amber-400 bg-clip-text text-transparent">brutal.</span>
                            </h2>
                            <p className="text-slate-400 text-lg">What changes when you stop begging and start operating.</p>
                        </motion.div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                            ...
                            <motion.div {...fadeInUp} className="p-8 md:p-10 rounded-3xl bg-gradient-to-br from-red-500/[0.06] to-red-900/[0.02] border border-red-500/15 shadow-[0_0_40px_-20px_rgba(239,68,68,0.15)]">
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    <h3 className="text-xl font-black text-red-400 uppercase tracking-wider">Before the Algorithm</h3>
                                </div>
                                <ul className="space-y-5">
                                    {[
                                        "You work hard but the results never come",
                                        "Constant frustration and mental exhaustion",
                                        "A sense of injustice and bad luck",
                                        "Random attempts with no method",
                                        "Anxiety from not controlling the future",
                                        "You depend on motivation to act"
                                    ].map((t, i) => (
                            ...
                            <motion.div {...fadeInUp} transition={{ delay: 0.1 }} className="p-8 md:p-10 rounded-3xl bg-gradient-to-br from-amber-500/[0.06] to-amber-900/[0.02] border border-amber-500/15 shadow-[0_0_40px_-20px_rgba(245,158,11,0.2)] relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-3 mb-8 relative z-10">
                                    ...
                                    <h3 className="text-xl font-black text-amber-400 uppercase tracking-wider">After the Algorithm</h3>
                                </div>
                                <ul className="space-y-5 relative z-10">
                                    {[
                                        "You operate with mechanical clarity and direction",
                                        "Inner alignment generates real results",
                                        "You understand it was not unfair, it was misaligned",
                                        "A pragmatic, repeatable method",
                                        "Latency is not anxiety, it is process",
                                        "You act by logic, not emotion"
                                    ].map((t, i) => (
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            ...
                            <p className="text-2xl md:text-4xl font-black text-white mb-6">
                                It is time to stop taking the obstacles of life <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">personally.</span>
                            </p>
                            <p className="text-lg text-slate-400 mb-10">
                                The universe is not against you. You just did not have the instruction manual. <span className="text-white font-bold">Until now.</span>
                            </p>
                            <motion.a
                                href="#oferta"
                                animate={{ scale: [1, 1.03, 1] }}
                            ...
                            >
                                <span>I WANT THE MANUAL NOW</span>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="text-center mb-10">
                                    <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-5 border border-purple-500/30 rounded-full bg-purple-500/5 aurora-border">
                                        ...
                                        <span className="text-purple-300 font-bold text-[10px] tracking-[0.15em] uppercase">Special Offer</span>
                                    </div>
                                ...
                                <div className="mb-10 flex justify-center">
                                    <img
                                        src="/algoritmo/capaingles.png"
                                        alt="The Algorithm of the Universe e-book mockup"
                                ...
                                <div className="space-y-3 mb-6 text-left">
                                    {[
                                        "Full e-book: The Algorithm of the Universe",
                                ...
                                <div className="mb-10 p-5 rounded-2xl bg-gradient-to-b from-purple-500/[0.06] to-transparent border border-purple-500/20 text-left">
                                    <p className="text-xs font-black text-purple-400 uppercase tracking-[0.2em] mb-4">🎁 Exclusive Bonuses</p>
                                    <div className="space-y-3">
                                        {[
                                            "Operational Reality Framework",
                                            "Personal misalignment diagnosis"
                                        ].map((item, idx) => (
                                            <div key={idx} className="flex items-center gap-3 text-slate-300">
                                ...
                                {/* CTA Button */}
                                <motion.a
                                    href="https://pay.hotmart.com/V104740321D?checkoutMode=10"
                                    target="_blank"
                    ...
                    <div className="max-w-3xl mx-auto">
                        <motion.div {...fadeInUp} className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 border border-rose-500/20 rounded-full bg-rose-500/5">
                                ...
                                <span className="text-rose-300 font-bold text-[10px] tracking-[0.2em] uppercase">Objections removed</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-black text-white">
                                Questions your mind will ask
                            </h2>
                        ...
                        <motion.div {...fadeInUp}>
                            <FAQ q="Is this just another self-help book?" a="No. The Algorithm of the Universe uses a technical, mechanical language on purpose. There are no creative visualizations, mantras or 'positive thinking' here. It is a pragmatic diagnosis of the system governing your results — and an operational manual to manipulate it." />
                            <FAQ q="Do I need to believe in something specific for this to work?" a="On the contrary. The material was designed to work regardless of your beliefs. It treats reality like an operating system: it does not matter whether you 'believe' in gravity — it works anyway. The Algorithm operates by the same logic." />
                            <FAQ q="R$29,90 feels too cheap. What's the catch?" a="There is no catch. The price is a strategic decision: we want as many adults as possible to access this knowledge. The value inside the material is infinitely greater than the price charged. The real question is: what does another year operating under a lie cost you?" />
                            <FAQ q="What if I do not like it?" a="You are covered by an unconditional 7-day guarantee. If the material does not make sense to you for any reason, just request a refund. Zero bureaucracy." />
                            <FAQ q="Is this a digital book?" a="Yes. The Algorithm of the Universe is an e-book. After your purchase, you get immediate access to the content. Read it on your phone, tablet or computer — whenever you want." />
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto text-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-4xl font-black mb-6 text-white">
                                Unconditional <span className="text-purple-400 font-black">7-Day</span> Guarantee
                            </h2>

                            <div className="space-y-4 text-lg text-gray-200 leading-relaxed mb-8">
                                <p>
                                    You have <span className="text-purple-400 font-bold">7 full days</span> to access the material,
                                    read it carefully and test the logic of the content in practice. If by the end of that period you feel
                                    the book is not for you, we will refund <span className="text-purple-400 font-bold">100% of your investment</span>.
                                </p>
                                <p>
                                    No questions, no bureaucracy and no friction. The proposal is simple: you get in,
                                    analyze the content for yourself and decide clearly whether this is the missing manual
                                    to reorganize your inner operation.
                                </p>
                            </div>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <motion.div {...fadeInUp}>
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-8 border border-red-500/20 rounded-full bg-red-500/5">
                                ...
                                <span className="text-red-400/70 font-bold text-[10px] uppercase tracking-[0.2em]">Final Note</span>
                            </div>
                            <p className="text-slate-600 text-sm italic leading-relaxed max-w-2xl mx-auto">
                                "If you are looking for pats on the back or validation for your victimhood, close this page. This material was written for adult minds that prefer raw truth that works over sweet lies that paralyze. The choice is yours."
                            </p>
                        </motion.div>
                    </div>
                </section>
...
export default AlgoritmoDoUniversoEN;
