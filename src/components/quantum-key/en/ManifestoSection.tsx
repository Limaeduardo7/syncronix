      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-foreground/80 animate-fade-up delay-100">
            Don't expect mercy from fate. The issue here is about accepting that you have in your hands <span className="neon-text font-bold">the power that many only dream of achieving</span>.
          </p>

          <p className="text-lg md:text-xl text-foreground/80 animate-fade-up delay-200">
            Most prefer the <span className="neon-text font-bold">shadow of ignorance</span>, where it's comfortable to blame the world, circumstances, anything that justifies <span className="neon-text font-bold">inertia</span>.
          </p>

          <p className="text-lg md:text-xl text-foreground/80 animate-fade-up delay-300">
            But you, who have come this far, are at a <span className="neon-text font-bold">crossroads</span>. Will you be just another one following the system's standard rules and <span className="neon-text font-bold">disappear into the crowd</span>?
          </p>

          <p className="text-xl md:text-2xl font-semibold text-foreground/90 animate-fade-up delay-400">
            Or will you have the <span className="neon-text font-bold">courage to take on the leading role</span> in your life?
          </p>
