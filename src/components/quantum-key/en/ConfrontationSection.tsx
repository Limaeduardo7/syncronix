    ...
    <section className="section-padding bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-up delay-200">
          <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
            Perhaps you've caught yourself staring into the abyss of a life that repeats itself in circles, feeling the crushing weight of routine that imprisons. But what you may not have realized yet is that the key to breaking these chains is in your hands.
          </p>
        </div>
        ...
        <div className="text-center mb-12 animate-fade-up delay-300">
          <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
            While most people are content to crawl through mediocrity, you've already taken the first step by recognizing that the power is there, dormant within you, just waiting for you to awaken it.
          </p>
        </div>
