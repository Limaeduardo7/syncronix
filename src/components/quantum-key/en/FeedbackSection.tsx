...
const feedbacks = [
  "/testimonial-en-1.jpg",
  "/testimonial-en-2.jpg",
  "/testimonial-en-3.jpg",
  "/testimonial-en-4.jpg",
  "/testimonial-en-5.jpg",
  "/testimonial-en-6.jpg",
  "/testimonial-en-7.jpg",
  "/testimonial-en-8.jpg",
  "/testimonial-en-9.jpg",
  "/testimonial-en-10.jpg",
  "/testimonial-en-11.jpg",
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-up">
          ...
          <p className="text-sm text-muted-foreground/60 italic mt-2">
            * Testimonials automatically translated from Portuguese
          </p>
        </div>
