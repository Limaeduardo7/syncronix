      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-up">
          <p className="text-2xl md:text-3xl font-semibold text-foreground/90">
            Have you ever asked yourself, what is reality?
          </p>
        </div>
        ...
        <div className="text-center mb-12 animate-fade-up delay-200">
          <p className="text-[16px] md:text-[17px] text-foreground/80 leading-relaxed">
            Reality is a holographic projection of consciousness, which receives Light from the Primordial Source, passes through your mental filters in the psychic center and projects your external experience on the space-time continuum!
          </p>
        </div>
        ...
        <div className="text-center mb-12 animate-fade-up">
          <div className="inline-block bg-primary px-8 py-6 rounded-2xl">
            <blockquote className="text-xl md:text-2xl font-light italic text-black leading-relaxed">
              Then Jesus declared: — In your Law it is written that God said: "You are gods."
            </blockquote>
        ...
        <div className="text-center mb-12 animate-fade-up">
          <p className="text-xl md:text-2xl font-semibold text-foreground/90 leading-relaxed mb-6">
            What we offer you here is nothing but the <span className="text-primary font-black">TRUTH</span>, nothing more.
          </p>
          <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
