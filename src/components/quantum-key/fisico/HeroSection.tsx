    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden py-20 pt-6 md:pt-10">
        ...
        <div className="mb-4 animate-fade-up">
          <p className="text-3xl md:text-4xl font-black text-yellow-400 uppercase tracking-wider drop-shadow-lg" style={{ textShadow: '0 0 20px rgba(250, 204, 21, 0.8), 0 0 40px rgba(250, 204, 21, 0.5)' }}>
            Livro Físico
          </p>
        </div>
